...
- [x] 02-01: Browser SPA + LiveKit SDK media/data-channel + agent-state pill + two-sided transcript
...
- [x] 03-01: Persona config → system prompt + voice id; frozen-prefix prompt layout
...
- [x] 05-01: Sliding-window + async summarization behind frozen prefix; flat-TTFT-over-time verification
